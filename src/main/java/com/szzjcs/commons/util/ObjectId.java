    ...
    static
    {
        try
        {
            ...
            try
            {
                ...
                System.out.println("[ObjectId.static]NetworkInterface: " + sb.toString());
            ...
            try
            {
                ...
                System.out.println("[ObjectId.static]processName: " + processName);
            }
            catch (Throwable t)
            {
            }
            ...
            System.out.println("[ObjectId.static]loaderId: " + loaderId);
