...
/**
 * 内存分页的数据结构,可以帮你把一个list很方便的转成DataPage
 * 
 * @author smartlv
 */
...
public class DataPage<K> implements Serializable
{
    ...
    {
        List<T> l = DataPage.subList(list, pageSize, pageNo);
    ...
    public String toString()
    {
        ...
        sb.append("], pageNo: ").append(pageNo).append(", pageSize: ").append(pageSize).append(", totalRecord: ")
